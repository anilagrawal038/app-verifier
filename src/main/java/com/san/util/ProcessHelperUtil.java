...
public class ProcessHelperUtil {
	...
	public static boolean isProcessRunning(Process process, String processLabel) {
		...
		try {
			...
			logger.trace("Orion OTT " + processLabel + " is in running mode");
			alreadyRunning = true;
		}
	...
	public static Process startProcess(int port, String jarPath) {
		String[] command = new String[] { "java", //
				...
				"--ott.manager.home=" + "", //
				"--ott.commons.home=" + "", //
				"--ott.manager.healthCheckAPI=" + "", //
				"--ott.manager.twoWayAuth=" + "" };
		...
		try {
			...
			try {
				...
				logger.debug("Orion OTT Process (" + jarPath + ") started successfully");
